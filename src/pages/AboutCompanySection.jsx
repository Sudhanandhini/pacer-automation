        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed mb-8">
              Over the years, we have perfected the art of providing IT infrastructure solutions that incorporate the most suitable IT products with best practices. Pacer Automation Private Limited was established in 1989 with a vision to provide professional IT infrastructure services to small, mid-cap, and large-cap clients.
            </p>
